...
class HomeController extends Controller
{
    ...
    public function dashboard($menu)
    {
        session_start();
        if (!isset($_COOKIE['kukis'])) {
            return redirect()->route('aait.login');
        }
        if (isset($_COOKIE['kukis'])) {
            $kukis = $_COOKIE['kukis'];
            if (jurnalhelper::cekkukis($kukis)) {
                ...
                if($menu == 'dashboard' ||  $menu == 'data_barang' || $menu == 'user_manajemen' || $menu == 'mutasi' || $menu == 'pengguna' || $menu == 'penghapusan' || $menu == 'export_to_excel'){
                    ...
                    if($_COOKIE['posisi'] == 'pengguna'){
                        ...
                        if($menu == 'dashboard'){
                            ...
                            return view('aait.dashboard', ['posisi' => $_COOKIE['posisi'], 'nama' => $_COOKIE['nama'], 'nik' => $_COOKIE['nik'], 'area' => $_COOKIE['area'], 'waktu' => $_COOKIE['current_time_formatted'], 'tanggal' => $_COOKIE['tanggal']], compact('menu'));
                        }
                        ...
                        if($menu == 'export_to_excel'){
                            ...
                            $mutasi_old = mutasi::all();
                            $penghapusan_old = penghapusan::all();
                            return view('aait.dashboard', ['posisi' => $_COOKIE['posisi'], 'nama' => $_COOKIE['nama'], 'nik' => $_COOKIE['nik'], 'area' => $_COOKIE['area'], 'waktu' => $_COOKIE['current_time_formatted'], 'tanggal' => $_COOKIE ['tanggal'], 'menu' => $menu], compact('data_user', 'penghapusan_old', 'mutasi_old', 'data_barang_old'));
                        }
                        ...
                        if($menu == 'dashboard'){
                            ...
                            jurnalhelper::resetsession();
                            jurnalhelper::resetedit();
                            return view('aait.dashboard', ['posisi' => $_COOKIE['posisi'], 'nama' => $_COOKIE['nama'], 'nik' => $_COOKIE['nik'], 'area' => $_COOKIE['area'], 'waktu' => $_COOKIE['current_time_formatted'], 'tanggal' => $_COOKIE['tanggal'], 'menu' => $menu, 'datanya' => $datanya]);
                        }
