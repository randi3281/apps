            ...
            <div class="col-md-3">
                <form action="/casniti/upload" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group text-center mt-5">
                        <button type="submit" class="btn btn-danger fixed-size rounded-5 me-2">Kembali</button>
                        <button type="submit" class="btn btn-primary fixed-size rounded-5">Submit</button>
                    </div>
                </form>
            </div>
        </div>
