...
@section('title', 'Desa Lebakbarang - Kab. Pekalongan')
@section('content')
    <!-- Slider Start -->
                ...
                <div class="col-lg-6 col-md-12 col-xl-7">
                    <div class="block">
                        ...
                        <div class="btn-container ">
                            <a class='btn btn-main-2 btn-icon btn-round-full'
                                href="{{ route('lebakbarang.sejarah-desa') }}">Lihat Profil<i
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="about-content pl-4 mt-4 mt-lg-0">
                        ...
                        <p class="mt-4 mb-5">Kegiatan karnaval Desa Lebakbarang dalam rangka memeriahkan HUT Republik
                            Indonesian ke-79 tahun 2024</p>
                    </div>
                </div>
            </div>
        </div>
