            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown01">
                  <li>
                    <a class="dropdown-item" href="sejarah-desa.php"
                      >Sejarah Desa</a
                    >
                  </li>
                  <li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown02">
                  ...
                  <li>
                    <a class="dropdown-item" href="keadaan-sosial.php"
                      >Keadaan Sosial</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="keadaan-ekonomi.php"
                      >Keadaan Ekonomi</a
                    >
                  </li>
                </ul>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown03">
                  <li>
                    <a class="dropdown-item" href="lembaga-pemerintahan.php"
                      >Lembaga Pemerintahan</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="lembaga-kemasyarakatan.php"
                      >Lembaga Kemasyarakatan</a
                    >
                  </li>
                  <li>
                    <a class="dropdown-item" href="pembagian-wilayah.php"
                      >Pembagian Wilayah</a
                    >
                  </li>
                  <li>
