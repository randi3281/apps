            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="department-content mt-5">
                        ...
                        <p class="lead">
                            Letak Geografi Desa Lebakbarang, terletak diantara : <br><br> Sebelah Utara : Desa Mendolo<br> Sebelah Selatan : Desa Sidomulyo <br> Sebelah Barat : Desa Kutorembet <br> Sebelah Timur : Desa Bantarkulon, Desa Kapundutan<br><br>
                        </p>
                        ...
                        <div class="divider my-4"></div>
                        <p class="lead">
                            Jarak ke ibu kota Kecamatan terdekat : 3,0 Km <br> Lama jarak tempuh ke ibu kota Kecamatan : 8 Menit <br> Jarak ke ibu kota Kabupaten : 13 KM <br> Lama jarak tempuh ke ibu kota Kabupaten : 30 Menit <br><br>
                        </p>
                        <h3 class="text-md">Jumlah Penduduk Berdasarkan Jenis Kelamin</h3>
                        <div class="divider my-4"></div>
                        <p class="lead">
                            Kepala Keluarga : 703 KK <br> Laki-laki </table>: 1155 Orang <br> Perempuan : 1086 Orang <br> Jumlah Penduduk : 2237 Orang <br><br>
                        </p>
                    </div>
                </div>
            </div>
