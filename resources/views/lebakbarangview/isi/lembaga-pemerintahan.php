            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active">
                            <a class='nav-link' href='pengaduan.html'>Pengaduan</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        <h1 class="text-capitalize mb-5 text-lg">PEMERINTAHAN</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="department-content mt-5">
                        ...
                        <p class="lead">
                            Kepala Desa : 1 orang <br> Sekretaris Desa : 1 orang <br> Perangkat Desa : 8 orang <br> Staf Desa : - orang <br> BPD : 5 orang <br> <br>
                        </p>
                    </div>
                </div>
            </div>
