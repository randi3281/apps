            ...
            <tbody>
                @foreach ($datanya as $data)
                    <tr>
                        ...
                        <td>{{ $data->landesk }}</td>
                        <td>
                            <a href="{{route('aait.proses.pengguna.data_barang.edit', ['id' => $data->id])}}" class="btn btn-warning">Edit</a>
                            |
                            <a href="{{route('aait.proses.pengguna.data_barang.delete', ['id' => $data->id])}}" class="btn btn-danger">Hapus</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
