    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <form action="{{ route('aait.proses.export.data_barang') }}" method="POST">
                        @csrf
        ...
        <div class="col-md-4">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {{-- <form action="{{route('aait.proses.export.mutasi')}}" method="POST"> --}}
                    <form action="{{ route('aait.proses.export.mutasi') }}" method="POST">
                        @csrf
                        <div class="form-group mb-2 ">
                            <label for="area">Area</label>
        ...
        <div class="col-md-4">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {{-- <form action="{{route('aait.proses.export.penghapusan')}}" method="POST"> --}}
                    <form action="{{ route('aait.proses.export.penghapusan') }}" method="POST">
                        @csrf
                        <div class="form-group mb-2 ">
                            <label for="area">Area</label>
